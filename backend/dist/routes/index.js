...
const restaurantCtrl = __importStar(require("../controllers/restaurant.controller"));
const dishCtrl = __importStar(require("../controllers/dish.controller"));
const router = (0, express_1.Router)();
router.get('/health', health_controller_1.health);
// Restaurants
